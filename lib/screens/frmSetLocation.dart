  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          ...
          appBar: CustomAppBar(key: key, title: const Text('Selecciona tu ubicación'), height: kToolbarHeight, actions: [
            IconButton(
                onPressed: () {
                  Navigator.pop(context);
                },
                ...
                return Container(
                  children: [
                      ...
                      builder: (context, state) {
                        if (state is AutoCompleteLoading) {
                            ...
                            return Container(
                              ...
                              height: 200,
                              color: state.autocomplete.isNotEmpty ? Colors.white.withOpacity(0.4) : Colors.transparent,
                    ...
                    Column(
                      children: [
                        //Mapa de MAPS
                        const GoogleMap(initialCameraPosition: CameraPosition(target: LatLng(10, 10))),
                        //Boton de continuar
                        ElevatedButton(
