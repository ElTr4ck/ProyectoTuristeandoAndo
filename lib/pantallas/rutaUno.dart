...
class _RutaUnoState extends State<RutaUno> {
  ...
  Future<Map<String, dynamic>> fetchPlaceDetailsFromApi(String placeId) async {
    String apiKey = 'AIzaSyBdskHJgjgw7fAn66BFZ6-II0k0ebC9yCM'; // Reemplaza con tu clave API de Google
  ...
  void _addMarker(Map<String, dynamic> placeDetails, String placeId) {
    final marker = Marker(
      ...
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRose), // Marcador azul
    );
